"""
Django settings for askyou project.
...
SECRET_KEY = 'ssz)qepcv^+1yf=$wgm&c8vo!xpq1&+z1vvia1u9#4aerzd2k7'
...
WSGI_APPLICATION = 'askyou.wsgi.application'
...
MEETING_ROOM_NO_BOOK_TIMES = ["22:00-07:00"]  # 会议室不准预定的时间段
MEETING_ROOM_USE_GAP = 20  # 会议室使用间隔(上一场会议使用完毕后,必须间隔20分钟才能再使用)
